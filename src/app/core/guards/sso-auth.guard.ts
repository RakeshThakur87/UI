...
@Injectable()
export class SsoAuthGuard implements CanActivate, CanActivateChild {
  ...
  private chekUser(route, state): boolean {
    debugger;
    const userType ="client";// this.authenticationService.getUserType();
    const isLogin =true;// this.authenticationService.isLogin();
    debugger;
    //isLogin=true;
