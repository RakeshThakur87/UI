...
@Component({
  selector: 'app-miscellaneous_bill_detail',
  templateUrl: './miscellaneousbill-list.html',
  styleUrls: ['./miscellaneousbill-list.css'],
  providers: [HttpApiService]
})
export class MiscellaneousBillDetailComponent implements OnInit {
  ;
